...
{{--                    </x-nav-link>--}}
                    @role('user')
                    <x-nav-link :href="route('useritems.index')" :active="request()->routeIs('dashboard')">
                        Items
                    </x-nav-link>
                    @else
                        <x-nav-link :href="route('items.index')" :active="request()->routeIs('dashboard')">
                            Items
                        </x-nav-link>
                        @endrole
                        ...
                        <x-nav-link :href="route('types.index')" :active="request()->routeIs('dashboard')">
                            Types
                        </x-nav-link>
                        ...
                        <x-nav-link :href="route('user.orders')" :active="request()->routeIs('dashboard')">
                            My orders
                        </x-nav-link>
                        @endrole
                        ...
                        <x-nav-link :href="route('supplies.index')" :active="request()->routeIs('dashboard')">
                            Supplies
                        </x-nav-link>
                        @endhasanyrole
